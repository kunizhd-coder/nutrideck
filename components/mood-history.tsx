    ...
    <div className="min-h-screen px-4 py-8 md:py-12 animate-page-enter">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 md:mb-12 flex items-start justify-between gap-4 animate-slide-in-left" style={{ animationDelay: '0.1s' }}>
          <div>
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-2 md:mb-4">Riwayat Mood</h1>
            <p className="text-base md:text-lg text-muted-foreground">Lacak emosi Anda selama 30 hari terakhir</p>
          </div>
          {entries.length > 0 && (
            <button
        ...
        {entries.length === 0 ? (
          <Card className="p-8 md:p-12 text-center animate-page-scale-in" style={{ animationDelay: '0.2s' }}>
            <p className="text-lg text-muted-foreground mb-4">Belum ada entri mood</p>
            <p className="text-sm text-muted-foreground">Mulai periksa mood Anda untuk membangun riwayat</p>
          </Card>
        ) : (
        ...
        {entries.length > 0 && (
          <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            <Card className="p-4 md:p-6 bg-gradient-to-br from-primary/10 to-primary/5">
              ...
              <p className="text-sm md:text-base text-muted-foreground">Total Pemeriksaan</p>
            </Card>
            ...
            <Card className="p-4 md:p-6 bg-gradient-to-br from-secondary/10 to-secondary/5">
              ...
              <p className="text-sm md:text-base text-muted-foreground">Hari Dilacak</p>
            </Card>
            ...
            <Card className="p-4 md:p-6 bg-gradient-to-br from-accent/10 to-accent/5">
              ...
              <p className="text-sm md:text-base text-muted-foreground">Mood Unik</p>
            </Card>
          </div>
        )}
        ...
        {showConfirm && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-sm p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-3">Hapus Riwayat?</h2>
              <p className="text-muted-foreground mb-6">
                Ini akan menghapus semua entri mood Anda secara permanen. Tindakan ini tidak dapat dibatalkan.
              </p>
